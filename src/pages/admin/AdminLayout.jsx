  ...
  return (
    <div className="fixed inset-0 bg-[#0a0f1e] text-white z-[100] flex flex-col lg:flex-row overflow-hidden">
      ...
      <header className="lg:hidden shrink-0 flex items-center gap-3 px-4 py-3 bg-gray-900/80 border-b border-white/5">
        ...
        <span className="text-lime-400 font-bold tracking-widest uppercase text-sm">Admin Panel</span>
      </header>
      ...
      >
        ...
        <div className="px-5 py-4 lg:py-5 border-b border-white/5">
          <div className="text-lime-400 font-bold text-lg tracking-widest uppercase">{import.meta.env.VITE_APP_NAME}</div>
          <div className="flex items-center gap-2 mt-1">
            <span className="text-gray-400 text-xs truncate">{user?.name}</span>
            <span className="text-xs px-2 py-0.5 rounded-full border bg-blue-500/20 text-blue-300 border-blue-500/30 shrink-0">Admin</span>
          </div>
        </div>
