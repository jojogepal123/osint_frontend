...
export default function IconWithFallback({ platform, size = 20 }) {
    ...
    const normalizedPlatform = iconMap[platform] || platform.toLowerCase().replace(/[\s().+]/g, "");
    ...
    const getIconUrl = () => {
        ...
        return typeof currentProvider === 'function' ? currentProvider(normalizedPlatform) : currentProvider;
    };
    const handleError = (e) => {
