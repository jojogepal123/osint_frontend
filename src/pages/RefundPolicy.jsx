          ...
          <div className="w-full h-full flex flex-col justify-start items-start space-y-4 animate-slide-up text-white">
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>
                ...
                within 5 days of placing the order. However, cancellation
              ...
              <li>
                REDOASISS LLP does not accept cancellation requests for
              ...
              <li>
                ...
                within 5 days of receipt of the product.
              </li>
              <li>
                ...
                notice of our customer service within 5 days of receiving the
