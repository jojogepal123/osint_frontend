  ...
  return (
    <div className="w-full h-full bg-slate-900/60 backdrop-blur-sm border border-slate-700/50 rounded-xl shadow-lg p-5 hover:border-cyan-500/30 transition-all duration-300">
      <div className="flex items-center gap-3 mb-5 pb-3 border-b border-slate-700/50">
        ...
        <h2 className="text-white text-lg font-semibold uppercase tracking-wide">Google Profile</h2>
      </div>
          ...
          <div className="flex justify-center lg:block flex-shrink-0">
            <div className="relative group">
              <img
                ...
                className="w-24 h-24 lg:w-28 lg:h-28 rounded-full border-2 border-cyan-500/30 shadow-xl shadow-cyan-500/10 object-cover"
              />
        ...
        <div className="space-y-3 flex-1">
          {name && (
            <div className="flex items-start gap-2">
              <span className="text-cyan-400 font-medium text-sm min-w-[80px]">Name:</span>
          ...
          {email && (
            <div className="flex items-start gap-2">
              <span className="text-cyan-400 font-medium text-sm min-w-[80px]">Email:</span>
          ...
          {personId && (
            <>
              <div className="flex items-start gap-2">
                <span className="text-cyan-400 font-medium text-sm min-w-[80px]">Maps:</span>
                <a
              ...
              <div className="flex items-start gap-2">
                <span className="text-cyan-400 font-medium text-sm min-w-[80px]">Person ID:</span>
          ...
          {sourceId && (
            <div className="flex items-start gap-2">
              <span className="text-cyan-400 font-medium text-sm min-w-[80px]">Updated:</span>
