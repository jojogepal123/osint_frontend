  ...
  return data.map((item, index) => (
    ...
    >
      <div className="flex items-center gap-3 mb-5 pb-3 border-b border-slate-700/50">
        ...
        <h2 className="text-white text-lg font-semibold uppercase tracking-wide">Gravatar</h2>
      </div>
      ...
      <div className="text-slate-300 flex flex-col lg:flex-row lg:items-start gap-6">
        ...
        <div className="flex flex-col space-y-3 flex-1">
          ...
          {item.profile_url && (
            <div className="flex items-start gap-2">
              <span className="text-cyan-400 font-medium text-sm min-w-[80px]">Profile:</span>
              <a
