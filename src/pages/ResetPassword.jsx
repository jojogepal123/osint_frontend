...
import backBtnicon from "../assets/back-button-image.png";
...
const ResetPassword = () => {
  ...
  const handleResetPassword = async (e) => {
    ...
    try {
      ...
      toast.success(
        "Your password has been reset! And Click the Back to redirect to login",
        {
          position: "top-right",
  ...
  return (
    <>
      {status && (
        <div className="bg-gradient-to-r from-lime-200 to-teal-800 bg-clip-text text-transparent z-10 text-end font-semibold">
          <div className=" p-4">
            <Link to="/login">
              <img src={backBtnicon} />
            </Link>
          ...
          <div className="flex flex-row justify-center items-center p-0 mx-4">
            <div className="rounded-[20px] text-white md:bg-gray-800 ">
              <div className="mx-auto flex flex-col w-[500px] gap-6 p-3 md:p-16">
                <div className="p-3 pt-0 text-[28px] bg-gradient-to-r from-lime-200 to-teal-800 bg-clip-text text-transparent text-center font-semibold">
                  Osint Work
                </div>
