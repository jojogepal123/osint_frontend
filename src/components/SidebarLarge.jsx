        ...
        <div className="flex-1 flex flex-col overflow-hidden">
                ...
                return (
                  <button
                    ...
                    className={`
                      ...
                      px-3 py-3 group relative overflow-hidden
                    `}
                  >
                    {item.active && (
                      <div className="absolute inset-0 bg-gradient-to-r from-cyan-500/10 to-emerald-500/10 animate-pulse" />
                    )}
                    <div className="relative flex items-center justify-center w-10 h-10 rounded-lg bg-slate-800/50 group-hover:bg-slate-700/50 transition-all duration-300">
                      <Icon className={`w-5 h-5 ${item.active ? "text-cyan-400" : "text-slate-400 group-hover:text-slate-200"} transition-colors duration-300`} />
                    </div>
                    <span className="relative flex-1 text-left text-sm font-medium">
                      {item.label}
                    </span>
                  </button>
                );
          ...
          {user && (
            <div className="px-3 pb-3">
              <button
                onClick={Logout}
                className="w-full flex items-center gap-3 px-3 py-3 rounded-xl text-red-400/70 hover:text-red-400 hover:bg-red-500/10 border border-transparent hover:border-red-500/30 transition-all duration-300 group"
              >
                <div className="w-10 h-10 rounded-lg bg-slate-800/50 group-hover:bg-red-500/20 flex items-center justify-center transition-all duration-300">
